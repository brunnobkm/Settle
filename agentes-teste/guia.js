(function () {
  ...
  const etapas = [
    ...
    {grupo:2,tipo:'Tarefa',titulo:'Um aviso para suas licitações',cenario:'Vamos simular um cenário: imagine que, no seu trabalho, você precisa saber se cada edital exige atestado de capacidade técnica e quer que o sistema avise isso em toda licitação. Como você configuraria esse aviso? Tente fazer isso na ferramenta.',tarefa:true},
