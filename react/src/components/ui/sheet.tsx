...
// largura das laterais (left/right); até 92vw no celular
const SHEET_SIZES = {
  sm: "[--sheet-width:24rem]",
  md: "[--sheet-width:27.5rem]",
  lg: "[--sheet-width:32rem]",
  xl: "[--sheet-width:40rem]",
} as const
...
function SheetContent({
  ...
  /**
   * Largura nas laterais (left/right): sm 384px, md 440px, lg 512px, xl 640px.
   * Sem size: 3/4 da tela, até 384px a partir do breakpoint sm.
   */
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          size
            ? cn(
                SHEET_SIZES[size],
                "data-[side=left]:w-(--sheet-width) data-[side=left]:max-w-[92vw] data-[side=right]:w-(--sheet-width) data-[side=right]:max-w-[92vw]"
              )
            : "data-[side=left]:w-3/4 data-[side=left]:sm:max-w-sm data-[side=right]:w-3/4 data-[side=right]:sm:max-w-sm",
