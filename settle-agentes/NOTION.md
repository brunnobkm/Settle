...
Protótipo: https://brunnobkm.github.io/Settle/settle-agentes/plataforma/
...
- Regra de repetição, só para a captura e para a chegada em Recomendadas: rodar só naquele momento ou também a cada atualização da licitação. Não se aplica ao envio para análise, que acontece uma vez só, ao horário agendado, que já se repete por definição, nem ao pedido do usuário.
