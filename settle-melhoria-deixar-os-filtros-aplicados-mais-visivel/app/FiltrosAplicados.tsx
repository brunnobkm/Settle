...
// para ficarem sempre visíveis. Clicar abre um popover: lista com múltipla seleção
// ou data (atalhos + calendário). Sem filtros, nada aparece.
...
export function FiltrosAplicados({
  ...
  return (
    <div
      ...
      className={cn(
        // barra de rolagem fina abaixo dos selos (a de sobreposição do macOS cobria o texto)
        "mt-3 flex max-h-15 items-center gap-2 overflow-x-auto pb-0.5 [scrollbar-width:thin] transition-[max-height,opacity,margin] duration-250 ease-out",
